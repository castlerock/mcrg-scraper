        ...
        if content:
            ...
            for index, tr in enumerate(trs):
                ...
                #    yield Request(url=match_link, callback=self.parse_score, meta=next_meta)
                    yield Request(url=match_link, callback=self.parse_final, meta=next_meta)
        ...
        if content:
            ...
            for index, tr in enumerate(trs):
                ...
                while True:
                    ...
                    next_meta = {"item": item}
                #    yield item
                #   yield Request(url=match_link, callback=self.parse_score, meta=next_meta)  #mat uncomment
                    yield Request(url=match_link, callback=self.parse_final, meta=next_meta)  #mat uncomment
    ...
    def parse_final(self, response):
        ...
        if content:
            try:
                ...
                item['team_a_1st_half'] = ""
                item['team_b_1st_half'] = ""
                item['team_a_2nd_half'] = ""
                item['team_b_2nd_half'] = ""
