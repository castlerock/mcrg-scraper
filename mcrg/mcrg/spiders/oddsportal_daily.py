...
class OddsportalDailySpider(scrapy.Spider):
    id = 7
    name = "oddsportal_daily"
            ...
            for t_li in tournaments:
                ...
                if tournament_link:
                    if tournament_link.count("/soccer/"):
                        ...
                        yield Request(url=url, callback=self.parse_tournament, meta=meta_data)
        ...
        if content:
            ...
            if trs:
                ...
                while True:
                    ...
                    if tr_class == "center nob-border" or tr_class is None:
                        break
                    ...
                    if match_date_time:
                        ...
                        print('>>>>>>>>>>>', date_time.date(), self.today)
        ...
        if content:
            ...
            if odds:
                if isinstance(odds, dict):
                    pinaccle_1 = odds.get("0")
                    pinaccle_x = odds.get("1")
                    pinaccle_2 = odds.get("2")
                else:
                    pinaccle_1, pinaccle_x, pinaccle_2 = odds
                data_list = [pinaccle_1, pinaccle_x, pinaccle_2]
                payout = self.calculate_payout(data_list)
            item["pinnacle_1"] = pinaccle_1
            item["pinnacle_x"] = pinaccle_x
            item["pinnacle_2"] = pinaccle_2
